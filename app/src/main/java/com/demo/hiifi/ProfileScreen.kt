...
class ProfileScreen : AppCompatActivity() {
    ...
    private lateinit var mobileNum : TextView
    private lateinit var bioSetting : TextView
    private lateinit var idSetting : TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mobileNum = findViewById(R.id.mobileSettings)
        bioSetting = findViewById(R.id.bioSettings)
        GetImage.getData(this, id.toString()) { result ->
            mobileNum.text = if(result?.phone == null) "Not Available" else result.phone
            bioSetting.text = if(result?.about == null) "Not Available" else result.about
        }
